...
/*   Updated: 2023/05/02 13:13:49 by kdaniely         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	sem_init(t_data *data)
{
	...
	data->forks = sem_open(FORK_SEM_NAME, O_CREAT, 0666, data->nb_philo);
	data->d_sem = sem_open(DEAD_SEM_NAME, O_CREAT, 0666, 1);
	data->p_sem = sem_open(PRINT_SEM_NAME, O_CREAT, 0666, 1);
	data->t_sem = sem_open(MEAL_SEM_NAME, O_CREAT, 0666, 1);
	data->c_sem = sem_open(MCOUNT_SEM_NAME, O_CREAT, 0666, 1);
